...
const NavBar = () => {
  ...
  return (
    <div className="flex flex-row justify-between border-b border-gray-400 pb-3 mt-3">
      <div className="w-34">
        <img src={assets.admin_logo} alt="admin-logo" className="w-full" />
      </div>
      
      <div onClick={logout} className="bg-[#5F6FFF] text-white border rounded-full text-center text-sm cursor-pointer w-32 flex justify-center items-center ">
